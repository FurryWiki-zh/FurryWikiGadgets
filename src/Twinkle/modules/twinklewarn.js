...
(function twinklewarn() {
		...
		levels: [
			...
			},
			{
				...
				list: {
					...
					'uw-advert': {
						level1: {
							label: window.wgULS('利用福瑞百科来发布广告或推广', '利用福瑞百科來發布廣告或推廣'),
							summary: window.wgULS(
								'注意：利用福瑞百科来发布广告或推广',
								'注意：利用福瑞百科來發布廣告或推廣'
							),
			...
			},
			{
				...
				list: {
					...
					'uw-socialmedia': {
						level1: {
							label: window.wgULS('将福瑞百科当作社交媒体使用', '將福瑞百科當作社交媒體使用'),
							summary: window.wgULS(
								'注意：将福瑞百科当作社交媒体使用',
								'注意：將福瑞百科當作社交媒體使用'
							),
	...
	Twinkle.warn.callback.evaluate = (e) => {
		...
		wikiPage.setFollowRedirect(true, false);
		wikiPage.load(Twinkle.warn.callbacks.main);
	};
