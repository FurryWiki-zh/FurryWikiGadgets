...
(function twinkleblock() {
	...
	Twinkle.block.callback = () => {
		...
		Window.addFooterLink(window.wgULS('封禁方针', '封鎖方針'), 'FWIKI:BLOCK');
	...
	Twinkle.block.blockPresetsInfo = {
		...
		'uw-3block': {
			...
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('违反[[FWIKI:3RR|回退不过三原则]]', '違反[[FWIKI:3RR|回退不過三原則]]'),
			summary: window.wgULS(
				'封禁通知：违反[[FWIKI:3RR|回退不过三原则]]',
				'封鎖通知：違反[[FWIKI:3RR|回退不過三原則]]'
			),
		},
		'uw-adblock': {
			autoblock: true,
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('[[FWIKI:SOAP|散发广告或宣传]]', '[[FWIKI:SOAP|散發廣告或宣傳]]'),
			summary: window.wgULS('封禁通知：[[FWIKI:SOAP|散发广告或宣传]]', '封鎖通知：[[FWIKI:SOAP|散發廣告或宣傳]]'),
		},
		'uw-attackblock': {
			autoblock: true,
			expiry: '1 day',
			nocreate: true,
			reason: window.wgULS(
				'[[FWIKI:CIV|行为无礼]]或[[FWIKI:NPA|人身攻击]]',
				'[[FWIKI:CIV|行為無禮]]或[[FWIKI:NPA|人身攻擊]]'
			),
			summary: window.wgULS(
				'封禁通知：[[FWIKI:CIV|行为无礼]]或[[FWIKI:NPA|人身攻击]]',
				'封鎖通知：[[FWIKI:CIV|行為無禮]]或[[FWIKI:NPA|人身攻擊]]'
			),
		},
		'uw-copyrightblock': {
			autoblock: true,
			...
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('持续[[FWIKI:COPYVIO|侵犯著作权]]', '持續[[FWIKI:COPYVIO|侵犯著作權]]'),
			summary: window.wgULS(
				'封禁通知：持续[[FWIKI:COPYVIO|侵犯著作权]]',
				'封鎖通知：持續[[FWIKI:COPYVIO|侵犯著作權]]'
			),
		...
		'uw-dblock': {
			...
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('持续[[FWIKI:VAN|删除内容]]', '持續[[FWIKI:VAN|刪除內容]]'),
			summary: window.wgULS('封禁通知：持续[[FWIKI:VAN|删除内容]]', '封鎖通知：持續[[FWIKI:VAN|刪除內容]]'),
		},
		'uw-hblock': {
			autoblock: true,
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('[[FWIKI:骚扰|骚扰]]其他用户', '[[FWIKI:騷擾|騷擾]]其他使用者'),
			summary: window.wgULS('封禁通知：[[FWIKI:骚扰|骚扰]]其他用户', '封鎖通知：[[FWIKI:騷擾|騷擾]]其他使用者'),
		},
		'uw-vblock': {
			autoblock: true,
			expiry: '1 day',
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('[[FWIKI:VAN|破坏]]', '[[FWIKI:VAN|破壞]]'),
			summary: window.wgULS('封禁通知：[[FWIKI:VAN|破坏]]', '封鎖通知：[[FWIKI:VAN|破壞]]'),
		},
		'uw-illegalblock': {
			autoblock: true,
			expiry: '1 day',
		...
		'uw-sockblock': {
			...
			forRegisteredOnly: true,
			nocreate: true,
			reason: window.wgULS('滥用[[FWIKI:SOCK|多个账号]]', '濫用[[FWIKI:SOCK|多個賬號]]'),
			summary: window.wgULS('封禁通知：滥用[[FWIKI:SOCK|多个账号]]', '封鎖通知：濫用[[FWIKI:SOCK|多個賬號]]'),
		...
		'uw-ublock': {
			...
			summary: window.wgULS(
				'封禁通知：您的用户名违反[[FWIKI:U|用户名方针]]',
				'封鎖通知：您的使用者名稱違反[[FWIKI:U|使用者名稱方針]]'
			),
		},
		'uw-ublock-illegal': {
			autoblock: true,
		...
		ucblock: {
			...
			nocreate: true,
			pageParam: true,
			reason: window.wgULS('屡次增加没有[[FWIKI:RS|可靠来源]]的资料', '屢次增加沒有[[FWIKI:RS|可靠來源]]的資料'),
			summary: window.wgULS(
				'封禁通知：屡次增加没有[[FWIKI:RS|可靠来源]]的资料',
				'封鎖通知：屢次增加沒有[[FWIKI:RS|可靠來源]]的資料'
			),
			templateName: 'uw-block',
		},
		npblock: {
		...
		'sock-contribs': {
			...
			reasonParam: true,
			reason: window.wgULS(
				'确认为[[FWIKI:SOCK|傀儡]]或真人傀儡 - 根据用户贡献确定',
				'確認為[[FWIKI:SOCK|傀儡]]或真人傀儡 - 根據使用者貢獻確定'
			),
			summary: window.wgULS(
				'封禁通知：确认为[[FWIKI:SOCK|傀儡]]或真人傀儡',
				'封鎖通知：確認為[[FWIKI:SOCK|傀儡]]或真人傀儡'
			),
			templateName: 'uw-blockindef',
		},
		'sock-cu': {
			...
			reasonParam: true,
			reason: window.wgULS(
				'确认为[[FWIKI:SOCK|傀儡]]或真人傀儡 - 用户查核确认',
				'確認為[[FWIKI:SOCK|傀儡]]或真人傀儡 - 使用者查核確認'
			),
			summary: window.wgULS(
				'封禁通知：确认为[[FWIKI:SOCK|傀儡]]或真人傀儡',
				'封鎖通知：確認為[[FWIKI:SOCK|傀儡]]或真人傀儡'
		...
		'uw-pblock': {
			...
			reasonParam: true,
			summary: window.wgULS(
				'封禁通知：您已被禁止编辑福瑞百科的部分区域',
				'封鎖通知：您已被禁止編輯福瑞百科的部分區域'
			),
		},
		'uw-pblockindef': {
			autoblock: true,
			...
			reasonParam: true,
			summary: window.wgULS(
				'封禁通知：您已被永久禁止编辑福瑞百科的部分区域',
				'封鎖通知：您已被永久禁止編輯福瑞百科的部分區域'
			),
		},
	};
	Twinkle.block.transformBlockPresets = () => {
	...
	Twinkle.block.callback.evaluate = (e) => {
		...
		if (toTag || toProtect) {
			...
			const wikiPage = new Morebits.wiki.page(userPage, window.wgULS('标记或保护用户页', '標記或保護使用者頁面'));
			wikiPage.setCallbackParameters(params);
			wikiPage.load(Twinkle.block.callback.taguserpage);
		}
		if (toUnblock) {
	...
	Twinkle.block.callback.issue_template = (formData) => {
		...
		const wikiPage = new Morebits.wiki.page(userTalkPage, window.wgULS('用户讨论页修改', '使用者討論頁修改'));
		wikiPage.setCallbackParameters(params);
		wikiPage.load(Twinkle.block.callback.main);
	};
