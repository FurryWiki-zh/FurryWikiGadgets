...
(function friendlytag() {
					...
					value: [
						{
							...
							description: window.wgULS(
								'可能需要进行清理，以符合福瑞百科的质量标准',
								'可能需要進行清理，以符合福瑞百科的質量標準'
							),
						},
						{
							tag: 'Cleanup rewrite',
				...
				},
				{
					...
					value: [
						...
						},
						{
							tag: 'External links',
							description: window.wgULS(
								'使用外部链接的方式可能不符合福瑞百科的方针',
								'使用外部連結的方式可能不符合福瑞百科的方針'
							),
						},
						{
							tag: 'Non-free',
		...
		},
		{
			...
			value: [
				...
				},
				{
					...
					description: window.wgULS('福瑞百科快捷方式', '福瑞百科快捷方式'),
				},
			],
		},
		{
	...
	Twinkle.tag.callback.evaluate = (e) => {
		...
		wikiPage.setCallbackParameters(params);
		wikiPage.load(Twinkle.tag.callbacks[Twinkle.tag.modeEn]);
	};
