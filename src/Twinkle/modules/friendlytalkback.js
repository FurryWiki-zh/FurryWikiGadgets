...
(function friendlytalkback() {
		...
		switch (value) {
			...
			case 'other':
				...
				work_area.append({
					...
					tooltip: window.wgULS(
						'您留下消息的完整页面名，例如“福瑞百科_talk:首页”。',
						'您留下訊息的完整頁面名，例如「福瑞百科_talk:首頁」。'
					),
					value: prev_page,
					required: true,
				});
	...
	Twinkle.talkback.noticeboards = {
		affp: {
			label: `FWIKI:AF/FP（${window.wgULS('过滤器处理/报告', '過濾器處理/報告')}）`,
			title: window.wgULS('过滤器错误报告有新回应', '過濾器錯誤報告有新回應'),
			content: `${window.wgULS(
				'您的[[福瑞百科_talk:过滤器处理/报告|过滤器错误报告]]已有回应，请前往查看。',
				'您的[[福瑞百科_talk:过滤器处理/报告|過濾器錯誤報告]]已有回應，請前往查看。'
			)}--~~`.concat('~~'),
			editSummary: window.wgULS(
				'有关[[福瑞百科_talk:过滤器处理/报告|过滤器错误报告]]的通知',
				'有關[[福瑞百科_talk:过滤器处理/报告|過濾器錯誤報告]]的通知'
			),
		...
		sbl: {
			...
			content: `${window.wgULS(
				'您的[[福瑞百科_talk:管理员告示板|垃圾链接黑名单请求]]已有回应，请前往查看。',
				'您的[[福瑞百科_talk:管理员告示板|垃圾連結黑名單請求]]已有回應，請前往查看。'
			)}--~~`.concat('~~'),
			editSummary: window.wgULS(
				'有关[[福瑞百科_talk:管理员告示板|垃圾链接黑名单请求]]的通知',
				'有關[[福瑞百科_talk:管理员告示板|垃圾連結黑名單請求]]的通知'
			),
		},
		shl: {
			...
			content: `${window.wgULS(
				'您的[[福瑞百科_talk:管理员告示板|垃圾链接白名单请求]]已有回应，请前往查看。',
				'您的[[福瑞百科_talk:管理员告示板|垃圾連結白名單請求]]已有回應，請前往查看。'
			)}--~~`.concat('~~'),
			editSummary: window.wgULS(
				'有关[[福瑞百科_talk:管理员告示板|垃圾链接白名单请求]]的通知',
				'有關[[福瑞百科_talk:管理员告示板|垃圾連結白名單請求]]的通知'
			),
		},
	};
